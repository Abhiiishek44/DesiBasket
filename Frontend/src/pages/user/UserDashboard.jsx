        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {allProducts.map((product) => (
              <div
                key={product._id}
                className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-[#3b82f6] transition-all duration-300 group hover:scale-105 hover:shadow-lg hover:shadow-[#3b82f6]/10"
              >
                {/* Product Image - Reduced height */}
                <div className="relative aspect-[4/3] bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center p-3">
                  <img
                    src={product.image}
                    alt={product.name}
                  ...
                  {/* Stock Badge - Smaller */}
                  {product.stock > 0 ? (
                    <div className="absolute top-1 left-1 bg-green-500 text-white  px-1.5 py-0.5 rounded text-xs font-medium">
                      In Stock
                    </div>
                  ) : (
                  ...
                  {/* Stock Count - Smaller */}
                  <div className="absolute top-1 right-1 bg-[#3b82f6] text-white text-xs px-1.5 py-0.5 rounded font-bold">
                    {product.stock}
                  </div>

                  {/* Wishlist Button - Smaller */}
                  <button
                    className="absolute top-8 right-1 p-1 bg-white/80 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-[#3b82f6] hover:text-white shadow-sm"
                ...
                <div className="p-3">
                  {/* Category - Smaller */}
                  <div className="mb-1">
                    <span className="text-[#3b82f6] text-xs font-medium bg-blue-50 px-1.5 py-0.5 rounded-full">
                      {product.category}
                    </span>
                  </div>

                  {/* Product Name - Smaller font */}
                  <h3 className="text-gray-900 font-semibold mb-1 line-clamp-1 group-hover:text-[#3b82f6] transition-colors text-sm">
                    {product.name}
                  </h3>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="bg-[#3b82f6] text-white rounded-lg px-2 py-1 text-xs font-medium hover:bg-[#3b82f6]/90 transition-colors"
                    >
                      Add
                    </button>
                  </div>
